//Graphics GraphicsDemo3 Allen Hung 15 points
import java.awt.*;
...
//1. The first number represents the x axis of the first endpoint of the line. The second number represents the y axis of the first endpoint of the line. The third number represents the x axis of the second endpoint of the line. The fourth number represents the y axis of the second endpoint of the line.
